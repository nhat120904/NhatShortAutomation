...
def test_imports():
    ...
    try:
        ...
        with open('/Users/nhatcuong/code_project/ShortGPT/shortGPT/engine/custom_audio_short_engine.py', 'r') as f:
            content = f.read()
        ...
        with open('/Users/nhatcuong/code_project/ShortGPT/gui/ui_tab_short_automation.py', 'r') as f:
            ui_content = f.read()
        ...
        with open('/Users/nhatcuong/code_project/ShortGPT/shortGPT/engine/__init__.py', 'r') as f:
            init_content = f.read()
