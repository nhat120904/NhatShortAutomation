...
class TextDisplayShortEngine(ContentShortEngine):
    def __init__(self, text: str, duration: int, background_video_name: str = "", background_music_name: str = "", 
                 background_image_name: str = "", short_id="", watermark=None, language: Language = Language.ENGLISH, 
                 voiceModule=None, video_effect=None, video_effect_params=None):
        ...
        super().__init__(short_id=short_id, short_type="text_display_shorts", 
                        ...
                        video_effect=video_effect, video_effect_params=video_effect_params)
