...
def demo_background_image():
    ...
    if image_assets.empty:
        ...
        if os.path.exists("public/white_reddit_template.png"):
            ...
            print("❌ No sample image found. Please add an image to the public folder first.")
            return
    else:
    ...
    print(f"\n{'='*70}")
    print("🎬 Demo Complete!")
    print("You can now play the generated videos to see the background images in action!")
